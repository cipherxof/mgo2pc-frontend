export default {
  ...
  'app.total': 'Totale', //playerstats page only
  'app.totalscore': 'Punteggi Totali', //leaderboard page only
  'app.exp': 'Esperienza', //leaderboard page only
  'app.stuns': 'Stordimenti', //playerstats and leaderboard pages
  'app.knifekills': 'Uccisioni con il Coltello', //leaderboard page only
  'app.scans': 'Scansioni', //leaderboard page only
  'app.deathmatch': 'Deathmatch', //playerstats and leaderboard pages
  'app.stealthdeathmatch': 'Deathmatch Ottico', //playerstats and leaderboard pages
  'app.teamdeathmatch': 'Deathmatch a Squadre', //playerstats and leaderboard pages
  'app.capturemission': 'Missione di Cattura', //playerstats and leaderboard pages
  'app.basemission': 'Missione per le Basi', //playerstats and leaderboard pages
  'app.bombmission': 'Missione Bomba', //playerstats and leaderboard pages
  'app.racemission': 'Missione Gara', //playerstats and leaderboard pages
  'app.rescuemission': 'Missione di Salvataggio', //playerstats and leaderboard pages
  'app.teamsneaking': 'Infiltrazione a Squadre', //playerstats and leaderboard pages
  'app.sneakingmission': "Missione d'Infiltrazione", //playerstats and leaderboard pages
  'app.solocapture': 'Cattura da Solitario', //playerstats and leaderboard pages
  'app.kdr': 'Rapporto Uccisioni / Morti', //leaderboard page only
  'app.wlr': 'Rapporto Vittorie / Sconfitte', //leaderboard page only
  ...
  'app.lockon': 'Agganciamento', //playerstats page only
  'app.other': 'Altro', //playerstats page only
  'app.all': 'Tutto', //playerstats page only
  'app.kills': 'Uccisioni', //playerstats page only
  'app.deaths': 'Morti', //playerstats page only
  'app.stunsreceived': 'Stordimenti Subiti', //playerstats page only
  'app.gamemodes': 'Modalità di Gioco', //playerstats page only
  'app.personalscores': 'Punteggi Personali', //playerstats page only
  'app.titlehistory': 'Cronologia Titoli', //playerstats page only
