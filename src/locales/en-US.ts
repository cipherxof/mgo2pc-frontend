export default {
  ...
  'app.weekly': 'Weekly', //playerstats and leaderboard pages
  'app.total': 'Total', //playerstats page only
  'app.totalscore': 'Total Score', //leaderboard page only
  'app.exp': 'Experience', //leaderboard page only
  'app.stuns': 'Stuns', //playerstats and leaderboard pages
  'app.knifekills': 'Knife Kills', //leaderboard page only
  'app.scans': 'Scans', //leaderboard page only
  'app.deathmatch': 'Deathmatch', //playerstats and leaderboard pages
  'app.stealthdeathmatch': 'Stealth Deathmatch', //playerstats and leaderboard pages
  'app.teamdeathmatch': 'Team Deathmatch', //playerstats and leaderboard pages
  'app.capturemission': 'Capture Mission', //playerstats and leaderboard pages
  'app.basemission': 'Base Mission', //playerstats and leaderboard pages
  'app.bombmission': 'Bomb Mission', //playerstats and leaderboard pages
  'app.racemission': 'Race Mission', //playerstats and leaderboard pages
  'app.rescuemission': 'Rescue Mission', //playerstats and leaderboard pages
  'app.teamsneaking': 'Team Sneaking', //playerstats and leaderboard pages
  'app.sneakingmission': 'Sneaking Mission', //playerstats and leaderboard pages
  'app.solocapture': 'Solo Capture', //playerstats and leaderboard pages
  'app.kdr': 'Kill / Death Ratio', //leaderboard page only
  'app.wlr': 'Win / Loss Ratio', //leaderboard page only
  'app.score': 'Score', //playerstats page only
  'app.name': 'Name', //leaderboard page only
  'app.rank': 'Rank', //leaderboard page only
  'app.rounds': 'Rounds', //playerstats page only
  'app.wins': 'Wins', //playerstats page only
  'app.timeplayed': 'Time Played', //playerstats page only
  'app.headshot': 'Headshot', //playerstats page only
  'app.lockon': 'Lock-on', //playerstats page only
  'app.other': 'Other', //playerstats page only
  'app.all': 'All', //playerstats page only
  'app.kills': 'Kills', //playerstats page only
  'app.deaths': 'Deaths', //playerstats page only
  'app.stunsreceived': 'Stuns Received', //playerstats page only
  'app.gamemodes': 'Game Modes', //playerstats page only
  ...
  'app.email': 'Email', //reused in password reset page
  ...
  'app.notice': 'Notice', //used for clan as well and maybe other places
  'app.head': 'Head',
