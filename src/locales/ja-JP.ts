export default {
  ...
  'app.weekly': '週間', //playerstats and leaderboard pages
  'app.total': '合計', //playerstats page only
  'app.totalscore': '合計スコア', //leaderboard page only
  'app.exp': '経験値', //leaderboard page only
  'app.stuns': 'スタン数', //playerstats and leaderboard pages
  'app.knifekills': 'ナイフキル数', //leaderboard page only
  'app.scans': 'スキャン回数', //leaderboard page only
  ...
  'app.basemission': 'ベース ミッション', //playerstats and leaderboard pages
  'app.bombmission': 'ボム ミッション', //playerstats and leaderboard pages
  ...
  'app.teamsneaking': 'チーム スニーキング', //playerstats and leaderboard pages
  'app.sneakingmission': 'スニーキング ミッション', //playerstats and leaderboard pages
  'app.solocapture': 'ソロ キャプチャー', //playerstats and leaderboard pages
  ...
  'app.all': 'すべて', //playerstats page only
  'app.kills': '殺害数', //playerstats page only
  'app.deaths': '死亡回数', //playerstats page only
  'app.stunsreceived': '被スタン数', //playerstats page only
